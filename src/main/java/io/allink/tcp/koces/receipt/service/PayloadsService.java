...
public class PayloadsService {
    ...
    public void insertWithJson(String merchantId, String payload, String posNo, String trxId){
        ...
        String sql = "INSERT INTO receipt_merchants_payloads(id, created_at, merchant_id, payload, pos_no, trx_id) VALUES (uuid_generate_v4(), now(), ?, ?::json, ?, ?)";
